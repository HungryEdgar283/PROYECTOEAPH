        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="editar_usuario.php?id=<?php echo $datos['idusuario']; ?>"><button type="button" class="btn btn-light"><i class="fi fi-rr-pencil"></i></button></a></td>
              <td><a href="../Servidor/borrar_usuario.php?id=<?php echo $datos['idusuario']; ?>"><button type="button" class="btn btn-danger"><i class="fi fi-rr-trash"></i></button></a></td>
                    <?php } ?>
